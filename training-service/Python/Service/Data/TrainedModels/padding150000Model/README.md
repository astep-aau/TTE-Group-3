# LSTM Model Training Results
    ...
    **Date:** 2025-12-04 23:02:05  
    **Project:** padding150000 - Route Time Estimation / Sequence Prediction  
    ...
    |--------|-------|------------|------|
    | **MAE (Mean Absolute Error)** | 117.26 s | 107.11 s | 97.41 s |
    ...
    ![Training Plot](padding150000_TrainingData.png)
