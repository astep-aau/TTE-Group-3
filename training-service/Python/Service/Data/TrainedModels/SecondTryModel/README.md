...
**Date:** 2025-11-27 15:06:12  
**Project:** SecondTry - Route Time Estimation / Sequence Prediction  
...
|--------|-------|------------|------|
| **MAE (Mean Absolute Error)** | 707.46 s | 132.78 s | 137.50 s |
...
![Training Plot](SecondTry_TrainingData.png)
